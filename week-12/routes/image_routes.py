...
from image_utils import save_product_image, delete_stored_image
...
def delete_image(product_id, image_id):
    ...
    # ── Remove files from configured storage backend ────────────
    delete_stored_image(image.filename, image.thumbnail)
